...
Public Class Form1
    ...
    Dim imagePathSeatPath As String = Application.StartupPath + "\airlineSeat.png"
    Dim imagePathSeatEmptyPath As String = Application.StartupPath + "\airlineSeatEmpty.png"
